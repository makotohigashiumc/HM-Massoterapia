...
@patch('controller.rota_clientes.confirmar_email')
...
@patch('controller.rota_clientes.recuperar_senha')
...
@patch('controller.rota_clientes.redefinir_senha')
...
@patch('controller.rota_clientes.api_cadastrar_cliente')
...
@patch('controller.rota_clientes.api_historico_agendamentos')
...
@patch('controller.rota_clientes.api_atualizar_cliente')
...
@patch('controller.rota_clientes.api_excluir_cliente')
...
@patch('controller.rota_clientes.api_me')
def test_api_me(mock_api_me):
    mock_api_me.return_value = {'id': 1}
    result = rota_clientes.api_me()
    assert 'id' in result

@patch('controller.rota_clientes.horarios_ocupados_massoterapeuta')
...
@patch('controller.rota_clientes.cancelar_agendamento_cliente')
...
@patch('controller.rota_clientes.limpar_historico_agendamentos')
