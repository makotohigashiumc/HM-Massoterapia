...
@patch('controller.rota_massoterapeuta.login_massoterapeuta')
...
@patch('controller.rota_massoterapeuta.cancelar_agendamento_com_notificacao')
...
@patch('controller.rota_massoterapeuta.excluir_cliente_por_massoterapeuta')
